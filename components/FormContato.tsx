...
export default function FormContato({ valores, onSubmit }: Props) {
  ...
  const escolherImagem = async () => {
    ...
    if (permissoes.status !== 'granted') {
      Alert.alert('Permissão necessária', 'Permita acesso à galeria para esco-lher uma imagem.');
      return;
    }
  ...
  return (
    <View>
      ...
      <TextInput placeholder="Telefone" value={telefone} on-ChangeText={setTelefone} style={global.input} />
      <TextInput placeholder="Endereço" value={endereco} on-ChangeText={setEndereco} style={global.input} />
